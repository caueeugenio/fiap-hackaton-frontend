...
export default function QuestionBox({
  ...
  const [newQuestionAnswer, setNewQuestionAnswer] = useState<boolean | null>(
    null
  );
  ...
  function handleDeleteQuestion(e: FormEvent) {
    ...
    deletedQuestions((questions: any) => {
      ...
      const questionExcluded = questions.find(
  ...
  return (
    <div key={question_id} className="flex flex-col ">
      <div className="flex items-center ">
        <div className="bg-[#CD6700] mr-4 text-primary-foreground p-2 flex rounded-sm items-center w-full ">
          ...
          <div className="flex p-2 gap-2">
            {page !== "/questionnaire" && (
              <div className="flex p-2 gap-2">
                ...
                <CircleX
                  className="h-5 w-5  text-white text-sm cursor-pointer"
        ...
        <div className="gap-2 flex max-h-14">
          {!teacher ? (
            ...
            <>
              <span className="bg-[#CD6700] p-4 text-primary-foreground rounded-sm">
                V
              </span>
      ...
      <Dialog open={openEditDialog} onOpenChange={setOpenEditDialog}>
        <DialogContent className="bg-white">
          <DialogHeader>
            ...
            <DialogDescription>
              Edite o enunciado da questão e a resposta abaixo:
            </DialogDescription>
          </DialogHeader>
