...
export default function NewQuestionnaire() {
    ...
    return (
        <main className="bg-tertiary_background flex flex-col items-center justify-center min-h-screen">
            <HeaderDetails title="Editar / Novo Questionário" />
            <form className="flex flex-col w-[800] my-5 gap-4">
                <InputText 
                    fieldName={"quiz_name"} 
                    content={"Nome"} 
                    placeholder={"Insira aqui o nome do questionário"} 
                    value={quizName}
                ...
                <div className="flex justify-end gap-4">
                    ...
                    <Button className='w-[200] bg-button_primary' type='submit'>Gerar Questões</Button>
                </div>
                ...
                <Button className='bg-button_primary' type='submit'>Salvar Edição / Criar Questionário</Button>
            </form>
        </main>
