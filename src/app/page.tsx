  ...
  return (
    <main className='sm:ml-14 h-screen'>
      <section className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 h-full'>
        <div className='p-6 shadow-md' style={{ backgroundColor: '#231313' }}>
          <Header />
        </div>
        <div
          className='bg-gray-800 p-6  shadow-md  '
          style={{ backgroundColor: '#491818' }}
        >
        ...
        <div className=' p-6 shadow-md' style={{ backgroundColor: '#732B2B' }}>
          <h2 className='text-white text-xl font-bold mb-2 text-center'>
            Prova 1
          </h2>
