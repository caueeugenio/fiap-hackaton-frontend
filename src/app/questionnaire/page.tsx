...
export default function Questionnaire() {
    ...
    const question = `A biologia celular abrange tantos as células procarióticas como eucarióticas. ...Lorem ipsum odor amet, consectetuer adipiscing elit. Metus velit quisque ante convallis ridiculus. Nostra nibh risus fermentum posuere magna ipsum maximus nostra. `
     const QuizText = () => {
        ...
        <div className='flex flex-row justify-center h-screen'>
            ...
            <div className="w-2/5 flex flex-col justify-between items-center bg-header_background pt-10">
                <div className='w-4/5 flex flex-col items-center'> 
                  ...
                  <QuestionBox  question_id={1} question={question}/>
                </div>
                <Button
                className={`${roboto.className} text-[18px] col-span-2 p-6 w-full mt-7 bg-button_primary mb-10 w-4/5`}
                type='submit'
                        >
                          Finalizar quizz
                </Button>
